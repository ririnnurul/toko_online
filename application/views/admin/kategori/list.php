	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<a href="<?php echo base_url('admin/kategori/delete/' .$kategori->id_kategori) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin Akan Menghapus Data Ini?')"><i class="fa fa-trash-o"></i>Delete</a>
			</td>
		</tr>
	<?php } ?>
	</tbody>
