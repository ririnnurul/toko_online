...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 02, 2020 at 10:49 AM
...
CREATE TABLE `header_transaksi` (
  ...
  `kode_transaksi` varchar(200) DEFAULT NULL,
...
(1, 'buku', 'buku', 1, '2020-08-29 06:14:22'),
(2, 'pensil', 'pensil', 2, '2020-08-29 06:14:22');
...
CREATE TABLE `pelanggan` (
  `id_pelanggan` int(11) NOT NULL,
  `id_user` int(11) NOT NULL,
  `status_pelanggan` varchar(200) NOT NULL,
...
CREATE TABLE `produk` (
  ...
  `status_produk` varchar(200) NOT NULL,
  `tanggal_post` datetime NOT NULL,
  `tanggal_update` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `transaksi` (
  ...
  `id_user` int(11) NOT NULL,
  `id_pelanggan` int(11) NOT NULL,
  `code_transaksi` varchar(200) NOT NULL,
  `id_produk` int(11) NOT NULL,
  `harga` int(11) NOT NULL,
...
CREATE TABLE `users` (
  ...
  `password` varchar(200) NOT NULL,
  `akses_level` varchar(200) NOT NULL,
  `tanggal_update` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'Ririn ', 'ririnnurulhidayah@gmail.com', 'Ririnn', '12345678', 'Admin', '2020-09-02 07:44:35');
